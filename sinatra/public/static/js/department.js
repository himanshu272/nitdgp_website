      ...
      if(semester!='programme_title') {
        ...
        html += ' <div class="card">\
                    <div class="card-header" role="tab">\
                      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapse'+index+semester.split(' ').join('_')+'" aria-expanded="true">\
                        <h5 class="mb-0">\
                          '+semester+' <i class="fa fa-angle-down rotate-icon"></i>\
                        </h5>\
                      </a>\
                    </div>\
                   <div id="collapse'+index+semester.split(' ').join('_')+'" class="collapse" role="tabpanel" >\
